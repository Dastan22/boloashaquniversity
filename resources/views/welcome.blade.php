...
<body>
                ...
                <div class="row h-100">
                    <div class="col-12 h-100">
                     ...
                     <!-- we check if the student is logged in  -->
                            ...
                            <button class="btn btn-info"><a href="{{url('/login')}}" style="color:#fff;">{{__('login')}}</a></button>
                            <button class="btn btn-danger"><a href="{{url('/register')}}" style="color:#fff;">{{__('register')}}</a></button>
                            <!-- show this links -->
                    ...
                    <nav class="classy-navbar justify-content-between" id="academyNav">
                        ...
                        <div class="calling-info">
                            <div class="call-center">
                                <a href=""><i class="icon-telephone-2"></i> <span>(+62) 081290348080</span></a>
                            </div>
                        </div>
                    </nav>
                </div>
    ...
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
            ...
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url({{asset('FrontEnd/img/bg-img/bg-1.jpg')}});">
                <div class="container h-100">
            ...
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img" style="background-image: url({{asset('FrontEnd/img/bg-img/bg-2.jpg')}});">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
